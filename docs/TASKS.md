...
- [ ] P1-02b FIDELITY REBUILD: match production Summary exactly — date-caps header + avatar; Nutrition card w/ concentric triple ring LEFT + colored stat stack RIGHT + "On pace" status; coaching strip; Streak+Water cards; flat TODAY'S MEALS list w/ orange protein-g; full-width 5-tab bar w/ center + (replaces NavPill on this screen)
